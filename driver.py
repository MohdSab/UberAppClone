...
class Driver:
    ...
    _passenger: The current passenger for the driver, or None if the driver
        is not currently driving a passenger.
    """
    ...
    def get_travel_time(self, destination: Location) -> int:
        ...
        """
        # TO-DO
        travel_dist = manhattan_distance(self.location, destination)
        return round(travel_dist / self._speed)
    ...
    def end_drive(self) -> None:
        ...
        Precondition: self._destination is not None.
    ...
    def end_trip(self) -> None:
        ...
        if self._passenger is not None:
            if self._destination is not None:
                self.is_idle = True
                self.location = self._passenger.destination
                self._destination = None
                self._passenger = None
